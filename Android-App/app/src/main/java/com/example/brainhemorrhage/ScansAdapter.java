...
public class ScansAdapter extends RecyclerView.Adapter<ScansAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (scan.getResult() != null && scan.getResult().toLowerCase().contains("normal") && !scan.getResult().toLowerCase().contains("abnormal")) {
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        TextView patientName, scanDate, resultBadge;
