...
public class FaqFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        faqList.add(new FaqItem("What types of scans are supported?", "Currently, HemoScan supports CT (Computed Tomography) scans of the brain in standard DICOM or image formats (JPEG/PNG)."));
